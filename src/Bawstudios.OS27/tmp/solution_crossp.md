# Note d’architecture cross‑plateforme (libengine2 / Bawstudios.OS27)
...
- **Android** :
  ...
  - Référencer `Bawstudios.OS27` avec condition TFM (`net10.0-android`) sans AOT.
